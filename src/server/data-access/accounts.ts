...
import { Account, accounts, AccountType, User } from "@/server/db/schema";
...
export async function getAccountByUserIdAndAccount(
  userId: User["id"],
...
export async function updateAccount(
  ...
  return await db.update(accounts).set(account).where(eq(accounts.id, id));
}
